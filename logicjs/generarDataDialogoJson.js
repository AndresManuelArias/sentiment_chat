'use strict';
const fs = require('fs'), GenerarDialogos = require('./GenerarDialogos'), UsuariosMensajes = require('./UsuariosMensajes'), DiasMensajes = require('./DiasMensajes'), ReadWordAnalitiyEmotion = require('./ReadWordAnalitiyEmotion'), AnaliticTrabajoEmotion = require('./AnaliticTrabajoEmotion'), GenerateSentimentToDialoge = require('./GenerateSentimentToDialoge');
...
let archivos = dialogos.map(dialogo => fs.readFileSync(`../base_data/dialogos/${dialogo}`, 'utf-8'));
...
console.log('sentimentToDialoge',sentimentToDialoge[0]);
