...
const fsC = require('fs'),
  GenerarDialogosC = require('./GenerarDialogos'),
  UsuariosMensajesC = require('./UsuariosMensajes'),
  DiasMensajesC = require('./DiasMensajes'),
  ReadWordAnalitiyEmotionC = require('./ReadWordAnalitiyEmotion')
  ;
